...
const socialLinks = [
  {
    href: "https://github.com/DANHCHUNG1405",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.facebook.com/danh.chung.9484",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
        ...
        height="24"
      >
        <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 5 3.66 9.13 8.44 9.88v-6.99H7.9v-2.89h2.54V9.5c0-2.5 1.5-3.89 3.8-3.89 1.1 0 2.24.2 2.24.2v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56v1.87h2.77l-.44 2.89h-2.33v6.99C18.34 21.13 22 17 22 12z" />
      </svg>
    ),
    alt: "Facebook",
  },
  ...
  {
    href: "https://www.instagram.com/danhh.chungg/",
    icon: (
      <svg
        width="25"
        height="24"
  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid-cols-2 lg:items-stretch">
        ...
        <form
          action="https://getform.io/f/bnlxvxjb"
          ...
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="ndanh675@gmail.com"
              />
            </div>
          </div>
          <div className="mb-4">
